...
export default function NavBar() {
  ...
  const Sidebar = (
    <div
      className={`fixed sidebar  top-0 left-0 h-full w-64 bg-black text-white transform ${
    ...
    >
      ...
      <Link to="/" className="hover:text-gray-400 items-center gap-4 rounded-lg bg-[#141414] p-2 flex" onClick={closeSidebar}>
        ...
        <Link to="/" className="hover:text-gray-400 rounded-lg bg-[#141414] p-2" onClick={closeSidebar}>
          Home
        </Link>
        <Link
          to="/"
        ...
        <Link to="/aboutus" className="hover:text-gray-400 rounded-lg bg-[#141414] p-2" onClick={closeSidebar}>
          About Us
        </Link>
        <Link to="/contact" className="hover:text-gray-400 rounded-lg bg-[#141414] p-2" onClick={closeSidebar}>
          Contact
        </Link>
      </nav>
    </div>
    ...
    <>
      <div className="fixed w-full px-[1.5rem] shadow-md py-8 navbar">
        <div className="flex items-center justify-between">
          <div className="flex gap-12 items-center w-full md:w-auto justify-center md:justify-start">
            <Link to="/">
