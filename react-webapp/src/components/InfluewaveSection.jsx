...
export default function InfluewaveSection() {
  return (
    ...
    <div class="h-[100vh] pt-64 w-[80%] p-12 mx-auto text-center">
      <h1 class="text-7xl font-bold">Influewave</h1>
      ...
      <p>
        ...
        ideas and projects through seamless collaboration and enriched
        connections.
      </p>
    </div>
  </section>
